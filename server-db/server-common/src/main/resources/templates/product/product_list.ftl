    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $(".edit-product").click(function () {
                var id = $("#productIdHidden").val();
                if (id && id != "") {
                    $.post("/productEdit", {id: id}, function (data) {
                        $('#editModal').html(data);
                    ...
                    <script>
                        $(".show-product").click(function () {
                            ...
                            if (id&& id != "") {
                                $.post("/productEdit", {id:id}, function (data) {
                                    $('#editModal').html(data);
                                    $("#productSaveForm :input").prop('disabled','disabled');//禁用所有的输入
                                    $("#saveButton").css('display','none');//隐藏保存按钮
                                    $(".js-upload").remove();
                                    $("#myModalLabel").text("商品查看");
