...
public class Swagger2ConfigApi {
    @Bean
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.basePackage("com.del.client.website.controller"))//扫描这个包中的api
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                .description("更多Spring Boot 相关文章请关注：http://blog.didispace.com/")
