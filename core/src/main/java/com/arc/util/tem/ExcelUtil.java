...
//            throw new SystemException("数据源中没有任何数据");
//        }
//
...
//        }catch (Exception e) {
//            e.printStackTrace();
//            //如果是SystemException，则直接抛出
//            if(e instanceof SystemException){
//                throw (SystemException)e;
//
//            //否则将其它异常包装成SystemException再抛出
//            }else{
...
//            //如果Excel中没有数据则提示错误
//            if(realRows<=1){
//                throw new SystemException("Excel文件中没有任何数据");
//            }
//
//
...
//            //如果有列名不存在，则抛出异常，提示错误
//            if(!isExist){
//                throw new SystemException("Excel中缺少必要的字段，或字段名称有误");
//            }
//
//
...
//                    throw new SystemException("Excel中有重复行，请检查");
//                }
//            }
//
//            //将sheet转换为list
...
//            }else{
//                e.printStackTrace();
//                throw new SystemException("导入Excel失败");
//            }
//        }
//        return resultList;
//    }
...
//            value=field.get(o);
//        }else{
//            throw new SystemException(o.getClass().getSimpleName() + "类不存在字段名 "+fieldName);
//        }
//
//        return value;
//    }
